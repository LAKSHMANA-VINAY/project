...
.registerbtn:hover {  
 ...
 <body> <center> 
     <h1>ONLINE CONSULTATION FORM</h1> 
     <a href="logout.php" ><button> logout </button></a>

    </center> 
  <form action="consultdb.php" method="POST"> 
   <div class="container"> 
    ...
    <select id="doctor" name="doctor" required>
           ...
           <option value="ravi" name="ravi">Dr.Ravi [oncology]</option>
           <option value="sam" name="sam">Dr.Sam [Neurology]</option>
           <option value="ram" name="ram">Dr.Ram [Family Medicine]</option>
           
     </Select>
    </div>
     <div> <label> AVAILABLE SLOTS : </label>
     <select id="slot" name="slots" required>
           <option value="NULL" name="NULL">--SELECT--</option>
           <option value="11" name="11">11-12</option>
           <option value="12" name="12">12-13</option>
           <option value="13" name="13">13-14</option>
           <option value="14" name="14">14-15</option>
